...
void GpuCounterDataSource::OnSetup(const SetupArgs &args)
{
   PPS_LOG("---yue-- OnSetup");
...
void GpuCounterDataSource::OnStart(const StartArgs &args)
{
   PPS_LOG("---yue OnStart");
...
void close_callback(GpuCounterDataSource::TraceContext ctx)
{
...
void GpuCounterDataSource::OnStop(const StopArgs &args)
{
   state = State::Stop;
...
void GpuCounterDataSource::wait_started()
{
...
void GpuCounterDataSource::register_data_source(const std::string &_driver_name)
{
   PPS_LOG("--yue-- register_data_source");
   driver_name = _driver_name;
   static perfetto::DataSourceDescriptor dsd;
   dsd.set_name("gpu.counters." + driver_name);
//   dsd.set_name("gpu.renderstages." + driver_name);
   Register(dsd);
}
...
void GpuCounterDataSource::trace(TraceContext &ctx)
{
   PPS_LOG("--yue-- trace");
...
void GpuCounterDataSource::trace_callback(TraceContext ctx)
{
   PPS_LOG("--yue-- trace_callback");
