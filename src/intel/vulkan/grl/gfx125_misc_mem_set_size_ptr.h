...
add(1)          g52<1>UD        g51<0,1,0>UD    0x00000000UD    { align1 WE_all 1N I@4 compacted };
add(8)          g3.8<1>UW       g3<1,1,0>UW     0x0008UW        { align1 WE_all 1Q I@4 compacted };
shl(16)         g18<1>D         g41<8,8,1>D     0x00000005UD    { align1 1H I@4 };
shl(16)         g10<1>D         g8<8,8,1>D      0x00000004UD    { align1 1H I@4 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@4 };
send(1)         g1UD            g52UD           nullUD          0x0220d500                0x00000000
...
mov(8)          g43<2>F         g2.4<0,1,0>F                    { align1 1Q F@4 compacted };
mov(8)          g45<2>F         g2.4<0,1,0>F                    { align1 2Q F@4 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N F@1 };
send(16)        g22UD           g43UD           nullUD          0x08403582                0x00000000
...
add(8)          g34<1>D         g4<8,4,2>D      g20<1,1,0>D     { align1 1Q F@4 compacted };
add(8)          g35<1>D         g6<8,4,2>D      g21<1,1,0>D     { align1 2Q F@3 compacted };
mov(16)         g50<4>UB        g2.2<0,1,0>UD                   { align1 1H };
cmp.l.f0.0(8)   g36<1>UD        g34<8,8,1>UD    g4<8,4,2>UD     { align1 1Q I@3 };
cmp.l.f0.0(8)   g37<1>UD        g35<8,8,1>UD    g6<8,4,2>UD     { align1 2Q I@3 };
mov(8)          g44<2>UD        g34<4,4,1>UD                    { align1 1Q $1.src };
mov(8)          g46<2>UD        g35<4,4,1>UD                    { align1 2Q $1.src };
mov(16)         g48<1>UD        g50<32,8,4>UB                   { align1 1H I@5 };
add(8)          g38<1>D         -g36<8,8,1>D    g4.1<8,4,2>D    { align1 1Q I@5 };
add(8)          g39<1>D         -g37<8,8,1>D    g6.1<8,4,2>D    { align1 2Q I@5 };
mov(8)          g44.1<2>UD      g38<4,4,1>UD                    { align1 1Q I@2 };
mov(8)          g46.1<2>UD      g39<4,4,1>UD                    { align1 2Q I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        nullUD          g44UD           g48UD           0x08000984                0x00000080
...
static const uint32_t gfx125_misc_mem_set_size_ptr_code[] = {
    ...
    0xe0080065, 0x0ff10043, 0xe2341c40, 0x00013303,
    0x64031c40, 0x00800395, 0x00041c69, 0x12058660,
    0x02462905, 0x00000005, 0x00041c69, 0x0a058660,
    0x02460805, 0x00000004, 0x80001c01, 0x00000000,
    0x00000000, 0x00000000, 0x80004031, 0x01140000,
    0xfa00340c, 0x00340000, 0x80001b01, 0x00000000,
    ...
    0x212b1461, 0x0011025c, 0x2a2d1461, 0x0011025c,
    0x80001101, 0x00000000, 0x00000000, 0x00000000,
    0x00044131, 0x16240000, 0xfb042b24, 0x000c0000,
    ...
    0xa1221440, 0x140e0402, 0xaa231340, 0x150e0602,
    0x00040061, 0x32070200, 0x00000244, 0x00000000,
    0x00031b70, 0x24050220, 0x52462205, 0x00440406,
    0x00131b70, 0x25050220, 0x52462305, 0x00440606,
    0x00033161, 0x2c060220, 0x00342205, 0x00000000,
    0x00133161, 0x2e060220, 0x00342305, 0x00000000,
    0x00041d61, 0x30050020, 0x00663207, 0x00000000,
    0x00031d40, 0x26052660, 0x06462405, 0x00440426,
    0x00131d40, 0x27052660, 0x06462505, 0x00440626,
    0x00031a61, 0x2c260220, 0x00342605, 0x00000000,
    0x00131a61, 0x2e260220, 0x00342705, 0x00000000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044131, 0x00000000, 0xf3082c24, 0x00023014,
...
const char *gfx125_misc_mem_set_size_ptr_sha1 = "1a75ad153cdb667b21653512e72700ea625edb84";
