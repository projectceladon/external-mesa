...
shl(16)         g18<1>D         g36<8,8,1>D     0x00000004UD    { align1 1H I@3 };
...
add(8)          g29<1>D         g6<8,4,2>D      g4<1,1,0>D      { align1 1Q F@4 compacted };
add(8)          g30<1>D         g8<8,4,2>D      g5<1,1,0>D      { align1 2Q F@3 compacted };
...
mov(8)          g37<2>UD        g22<4,4,1>UD                    { align1 1Q $1.src };
mov(8)          g39<2>UD        g23<4,4,1>UD                    { align1 2Q $1.src };
cmp.l.f0.0(8)   g31<1>UD        g29<8,8,1>UD    g6<8,4,2>UD     { align1 1Q I@6 };
cmp.l.f0.0(8)   g32<1>UD        g30<8,8,1>UD    g8<8,4,2>UD     { align1 2Q I@6 };
mov(8)          g41<2>UD        g29<4,4,1>UD                    { align1 1Q $2.src };
mov(8)          g43<2>UD        g30<4,4,1>UD                    { align1 2Q $2.src };
add(8)          g26<1>D         -g24<8,8,1>D    g10.1<8,4,2>D   { align1 1Q I@7 };
add(8)          g27<1>D         -g25<8,8,1>D    g12.1<8,4,2>D   { align1 2Q I@7 };
add(8)          g33<1>D         -g31<8,8,1>D    g6.1<8,4,2>D    { align1 1Q I@6 };
add(8)          g34<1>D         -g32<8,8,1>D    g8.1<8,4,2>D    { align1 2Q I@6 };
mov(8)          g37.1<2>UD      g26<4,4,1>UD                    { align1 1Q I@4 };
mov(8)          g39.1<2>UD      g27<4,4,1>UD                    { align1 2Q I@4 };
mov(8)          g41.1<2>UD      g33<4,4,1>UD                    { align1 1Q I@4 };
mov(8)          g43.1<2>UD      g34<4,4,1>UD                    { align1 2Q I@4 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
send(16)        g28UD           g37UD           nullUD          0x08200980                0x00000000
                            ugm MsgDesc: ( load, a64, d8u32, V1, L1STATE_L3MOCS dst_len = 2, src0_len = 4, src1_len = 0 flat ) base_offset 0  { align1 1H $1 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $2.src };
mov(16)         g45<1>UD        g28<32,8,4>UB                   { align1 1H $1.dst };
...
static const uint32_t gfx125_misc_copy_mock_code[] = {
    ...
    0xe22f1b40, 0x00012e03, 0x64031b40, 0x00800395,
    0x00041b69, 0x12058660, 0x02462405, 0x00000004,
    ...
    0xa11d1440, 0x040e0602, 0xaa1e1340, 0x050e0802,
    0x00031c70, 0x18050220, 0x52461605, 0x00440a06,
    0x00131c70, 0x19050220, 0x52461705, 0x00440c06,
    0x00033161, 0x25060220, 0x00341605, 0x00000000,
    0x00133161, 0x27060220, 0x00341705, 0x00000000,
    0x00031e70, 0x1f050220, 0x52461d05, 0x00440606,
    0x00131e70, 0x20050220, 0x52461e05, 0x00440806,
    0x00033261, 0x29060220, 0x00341d05, 0x00000000,
    0x00133261, 0x2b060220, 0x00341e05, 0x00000000,
    0x00031f40, 0x1a052660, 0x06461805, 0x00440a26,
    0x00131f40, 0x1b052660, 0x06461905, 0x00440c26,
    0x00031e40, 0x21052660, 0x06461f05, 0x00440626,
    0x00131e40, 0x22052660, 0x06462005, 0x00440826,
    0x00031c61, 0x25260220, 0x00341a05, 0x00000000,
    0x00131c61, 0x27260220, 0x00341b05, 0x00000000,
    0x00031c61, 0x29260220, 0x00342105, 0x00000000,
    0x00131c61, 0x2b260220, 0x00342205, 0x00000000,
    0x80001b01, 0x00000000, 0x00000000, 0x00000000,
    0x00044131, 0x1c140000, 0xf3002524, 0x00020000,
    0x80003201, 0x00000000, 0x00000000, 0x00000000,
    0x00042161, 0x2d050020, 0x00661c07, 0x00000000,
...
const char *gfx125_misc_copy_mock_sha1 = "41bfd9f2103ed944982376c987134254c1a716e3";
