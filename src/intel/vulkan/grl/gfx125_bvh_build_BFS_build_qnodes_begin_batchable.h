...
add(8)          g10.8<1>UW      g10<1,1,0>UW    0x0008UW        { align1 WE_all 1Q I@3 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@2 };
send(1)         g1UD            g113UD          nullUD          0x0220d500                0x00000000
                            ugm MsgDesc: ( load, a32, d32, V16, transpose, L1STATE_L3MOCS dst_len = 2, src0_len = 1, src1_len = 0 flat ) base_offset 0  { align1 WE_all 1N $0 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
mov(16)         g20<1>D         g10<8,8,1>UW                    { align1 1H };
and(16)         g47<1>UD        g20<1,1,0>UD    0x0000000fUD    { align1 1H I@1 compacted };
shl(16)         g19<1>D         g78<8,8,1>D     0x00000004UD    { align1 1H I@5 };
add(16)         g24<1>D         g19<1,1,0>D     g47<1,1,0>D     { align1 1H I@1 compacted };
...
mov(8)          g26<1>UD        g96.1<8,4,2>UD                  { align1 1Q F@4 };
add(8)          g100<1>D        g96<8,4,2>D     24D             { align1 1Q compacted };
mov(8)          g27<1>UD        g11.1<8,4,2>UD                  { align1 2Q F@3 };
add(8)          g28<1>D         g11<8,4,2>D     24D             { align1 2Q compacted };
cmp.l.f0.0(8)   g101<1>UD       g100<8,8,1>UD   g96<8,4,2>UD    { align1 1Q I@3 };
mov(8)          g80<2>UD        g100<4,4,1>UD                   { align1 1Q };
cmp.l.f0.0(8)   g29<1>UD        g28<8,8,1>UD    g11<8,4,2>UD    { align1 2Q I@3 };
mov(8)          g82<2>UD        g28<4,4,1>UD                    { align1 2Q };
add(8)          g102<1>D        -g101<8,8,1>D   g96.1<8,4,2>D   { align1 1Q I@4 };
add(8)          g30<1>D         -g29<8,8,1>D    g11.1<8,4,2>D   { align1 2Q I@3 };
mov(8)          g80.1<2>UD      g102<4,4,1>UD                   { align1 1Q I@2 };
mov(8)          g82.1<2>UD      g30<4,4,1>UD                    { align1 2Q I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        g31UD           g80UD           nullUD          0x08201582                0x00000000
                            ugm MsgDesc: ( load_cmask, a64, d32, x, L1STATE_L3MOCS dst_len = 2, src0_len = 4, src1_len = 0 flat ) base_offset 0  { align1 1H $1 };
cmp.l.f0.0(16)  null<1>UD       g24<8,8,1>UD    g31<8,8,1>UD    { align1 1H $1.dst };
(+f0.0) if(16)  JIP:  LABEL0          UIP:  LABEL0              { align1 1H };
add(8)          g103<1>D        g96<8,4,2>D     36D             { align1 1Q compacted };
add(8)          g32<1>D         g11<8,4,2>D     36D             { align1 2Q compacted };
add(8)          g36<1>D         g96<8,4,2>D     44D             { align1 1Q compacted };
add(8)          g37<1>D         g11<8,4,2>D     44D             { align1 2Q compacted };
shl(16)         g39<1>D         g24<8,8,1>D     0x00000004UD    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.dst };
...
cmp.l.f0.0(8)   g33<1>UD        g32<8,8,1>UD    g11<8,4,2>UD    { align1 2Q I@7 };
mov(8)          g81<2>UD        g103<4,4,1>UD                   { align1 1Q $1.src };
mov(8)          g83<2>UD        g32<4,4,1>UD                    { align1 2Q $1.src };
add(16)         g41<1>D         g36<1,1,0>D     g39<1,1,0>D     { align1 1H I@7 compacted };
cmp.l.f0.0(16)  g38<1>UD        g36<1,1,0>UD    0x0000002cUD    { align1 1H compacted };
add(8)          g105<1>D        -g104<8,8,1>D   g96.1<8,4,2>D   { align1 1Q I@6 };
add(8)          g34<1>D         -g33<8,8,1>D    g11.1<8,4,2>D   { align1 2Q I@6 };
cmp.l.f0.0(16)  g43<1>UD        g41<1,1,0>UD    g36<1,1,0>UD    { align1 1H I@4 compacted };
mov(8)          g85<2>UD        g41<4,4,1>UD                    { align1 1Q };
mov(8)          g87<2>UD        g42<4,4,1>UD                    { align1 2Q };
mov(8)          g81.1<2>UD      g105<4,4,1>UD                   { align1 1Q I@5 };
mov(8)          g83.1<2>UD      g34<4,4,1>UD                    { align1 2Q I@5 };
add3(16)        g45<1>D         -g38<8,8,1>D    g26<8,8,1>D     -g43<1,1,1>D { align1 1H I@5 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@2 };
send(16)        g35UD           g81UD           nullUD          0x08201582                0x00000000
                            ugm MsgDesc: ( load_cmask, a64, d32, x, L1STATE_L3MOCS dst_len = 2, src0_len = 4, src1_len = 0 flat ) base_offset 0  { align1 1H $1 };
mov(8)          g85.1<2>UD      g45<4,4,1>UD                    { align1 1Q I@1 };
mov(8)          g87.1<2>UD      g46<4,4,1>UD                    { align1 2Q I@2 };
add(16)         g5<1>D          g35<1,1,0>D     g24<1,1,0>D     { align1 1H $1.dst compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
mach(8)         g22<1>UD        g5<1,1,0>UD     0x00000058UD    { align1 1Q compacted AccWrEnable };
...
cmp.l.f0.0(8)   g55<1>UD        g53<8,8,1>UD    g98<8,4,2>UD    { align1 1Q I@3 };
cmp.l.f0.0(8)   g56<1>UD        g54<8,8,1>UD    g17<8,4,2>UD    { align1 2Q I@3 };
add(16)         g58<1>D         g53<1,1,0>D     64D             { align1 1H compacted };
mach(8)         g23<1>UD        g6<8,8,1>UD     0x00000058UD    { align1 2Q AccWrEnable };
...
add3(16)        g57<1>D         g51<8,8,1>D     g22<8,8,1>D     -g55<1,1,1>D { align1 1H I@4 };
...
static const uint32_t gfx125_bvh_build_BFS_build_qnodes_begin_batchable_code[] = {
    ...
    0x80030061, 0x0a054410, 0x00000000, 0x76543210,
    0x00040061, 0x4e050220, 0x00000024, 0x00000000,
    0xe2711b40, 0x00017003, 0x640a1b40, 0x00800a95,
    0x80001a01, 0x00000000, 0x00000000, 0x00000000,
    0x80004031, 0x01140000, 0xfa00710c, 0x00340000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x