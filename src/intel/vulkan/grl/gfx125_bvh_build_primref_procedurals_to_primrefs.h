...
cmp.l.f0.0(16)  null<1>UD       g28<8,8,1>UD    g3.1<0,1,0>UD   { align1 1H I@1 };
mov(16)         g23<1>UD        g3.3<0,1,0>UB                   { align1 1H };
and(16)         g10<1>UD        g3<0,1,0>UD     0x00ffffffUD    { align1 1H };
(+f0.0) if(16)  JIP:  LABEL1          UIP:  LABEL0              { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.dst };
mov(8)          g122.1<2>D      g2.7<0,1,0>D                    { align1 1Q };
mov(8)          g124.1<2>D      g2.7<0,1,0>D                    { align1 2Q };
mov(8)          g122<2>D        g2.6<0,1,0>D                    { align1 1Q I@2 };
mov(8)          g124<2>D        g2.6<0,1,0>D                    { align1 2Q I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        g30UD           g122UD          nullUD          0x0880f582                0x00000000
...
mov(8)          g123<2>UD       g46<4,4,1>UD                    { align1 1Q $2.src };
mov(8)          g125<2>UD       g47<4,4,1>UD                    { align1 2Q $2.src };
...
mov(8)          g125.1<2>UD     g51<4,4,1>UD                    { align1 2Q I@1 };
mov(8)          g123.1<2>UD     g50<4,4,1>UD                    { align1 1Q I@2 };
add(16)         g63<1>D         -g61<1,1,0>D    g50<1,1,0>D     { align1 1H I@4 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        g51UD           g123UD          nullUD          0x0880f582                0x00000000
                            ugm MsgDesc: ( load_cmask, a64, d32, xyzw, L1STATE_L3MOCS dst_len = 8, src0_len = 4, src1_len = 0 flat )  base_offset 0  { align1 1H $3 };
mov(8)          g124<2>UD       g59<4,4,1>UD                    { align1 1Q $3.src };
mov(8)          g126<2>UD       g60<4,4,1>UD                    { align1 2Q $3.src };
mov(8)          g124.1<2>UD     g63<4,4,1>UD                    { align1 1Q I@2 };
mov(8)          g126.1<2>UD     g64<4,4,1>UD                    { align1 2Q I@2 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        g64UD           g124UD          nullUD          0x08403582                0x00000000
...
add(16)         g123<1>D        g117<1,1,0>D    16D             { align1 1H $3.src compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $4.src };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $4.src };
mov(4)          g123<4>UD       g54.1<8,2,4>UD                  { align1 WE_all 1N $3.src };
...
static const uint32_t gfx125_bvh_build_primref_procedurals_to_primrefs_code[] = {
    ...
    0xa01c1940, 0x1a001802, 0x80002101, 0x00000000,
    0x00000000, 0x00000000, 0x00041970, 0x00010220,
    0x52461c05, 0x00000324, 0x00040061, 0x17050020,
    0x0000031c, 0x00000000, 0x00040065, 0x0a058220,
    0x02000304, 0x00ffffff, 0x01040022, 0x0001c060,
    0x000003b0, 0x00000340, 0x80002001, 0x00000000,
    0x00000000, 0x00000000, 0x00030061, 0x7a260660,
    0x000002e4, 0x00000000, 0x00130061, 0x7c260660,
    0x000002e4, 0x00000000, 0x00031a61, 0x7a060660,
    0x000002c4, 0x00000000, 0x00131a61, 0x7c060660,
    0x000002c4, 0x00000000, 0x80001901, 0x00000000,
    0x00000000, 0x00000000, 0x00044231, 0x1e440000,
    0xfb047a24, 0x003c0000, 0x00032241, 0x20010220,
    ...
    0x00033261, 0x7b060220, 0x00342e05, 0x00000000,
    0x00133261, 0x7d060220, 0x00342f05, 0x00000000,
    0xa03b0040, 0x01002e03, 0xa02c1d40, 0x2a002602,
    0x273d1a70, 0x2e003b03, 0x0004a252, 0x32040e68,
    0x0e2e2005, 0x30052c05, 0x00131961, 0x7d260220,
    0x00343305, 0x00000000, 0x00031a61, 0x7b260220,
    0x00343205, 0x00000000, 0xa03f1c40, 0x32023d02,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044331, 0x33440000, 0xfb047b24, 0x003c0000,
    0x00033361, 0x7c060220, 0x00343b05, 0x00000000,
    0x00133361, 0x7e060220, 0x00343c05, 0x00000000,
    0x00031a61, 0x7c260220, 0x00343f05, 0x00000000,
    0x00131a61, 0x7e260220, 0x00344005, 0x00000000,
    0xe7412370, 0x7f833500, 0xe7432370, 0x7f833300,
    0xe7472370, 0x7f833700, 0x20451265, 0x43004103,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044431, 0x40240000, 0xfb047c24, 0x000c0000,
    ...
    0x25591962, 0x39003300, 0x01041162, 0x0c058220,
    ...
    0x00000188, 0x00000188, 0x00041b69, 0x72058660,
    ...
    0x20121c66, 0x71001c03, 0x80003201, 0x00000000,
    0x00000000, 0x00000000, 0x00041c52, 0x79040660,
    ...
    0xfb0c2324, 0x003c0444, 0x80003401, 0x00000000,
    0x00000000, 0x00000000, 0xa07b3340, 0x01007503,
    ...
    0x20170040, 0x0e000600, 0x80003401, 0x00000000,
    ...
    0x80003401, 0x00000000, 0x00000000, 0x00000000,
    0x80023361, 0x7b070220, 0x00423627, 0x00000000,
...
const char *gfx125_bvh_build_primref_procedurals_to_primrefs_sha1 = "bb4e71169cff565a67c696efba8f15d124687b2a";
