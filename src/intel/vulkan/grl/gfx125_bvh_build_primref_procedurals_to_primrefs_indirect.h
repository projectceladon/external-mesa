...
mov(8)          g46.1<2>D       g3.1<0,1,0>D                    { align1 2Q };
mov(8)          g44.1<2>D       g3.1<0,1,0>D                    { align1 1Q };
and(16)         g10<1>UD        g3.2<0,1,0>UD   0x00ffffffUD    { align1 1H };
mov(8)          g46<2>D         g3<0,1,0>D                      { align1 2Q I@3 };
mov(8)          g44<2>D         g3<0,1,0>D                      { align1 1Q I@3 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        g22UD           g44UD           nullUD          0x08200580                0x00000000
                            ugm MsgDesc: ( load, a64, d32, V1, L1STATE_L3MOCS dst_len = 2, src0_len = 4, src1_len = 0 flat )  base_offset 0  { align1 1H $2 };
cmp.l.f0.0(16)  null<1>UD       g29<8,8,1>UD    g22<8,8,1>UD    { align1 1H @6 $2.dst };
mov(16)         g23<1>UD        g3.11<0,1,0>UB                  { align1 1H };
(+f0.0) if(16)  JIP:  LABEL1          UIP:  LABEL0              { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.dst };
mov(8)          g45.1<2>D       g2.7<0,1,0>D                    { align1 1Q $2.src };
mov(8)          g47.1<2>D       g2.7<0,1,0>D                    { align1 2Q $2.src };
mov(8)          g45<2>D         g2.6<0,1,0>D                    { align1 1Q I@2 };
mov(8)          g47<2>D         g2.6<0,1,0>D                    { align1 2Q I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        g31UD           g45UD           nullUD          0x08803580                0x00000000
                            ugm MsgDesc: ( load, a64, d32, V4, L1STATE_L3MOCS dst_len = 8, src0_len = 4, src1_len = 0 flat )  base_offset 0  { align1 1H $3 };
mul(8)          acc0<1>UD       g29<8,8,1>UD    g35<16,8,2>UW   { align1 1Q $3.dst };
mul(16)         g41<1>D         g29<8,8,1>D     g35<16,8,2>UW   { align1 1H $3.dst };
mul(16)         g51<1>D         g29<8,8,1>D     g35.1<16,8,2>UW { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $2.src };
mul(16)         g43<1>D         g29<8,8,1>D     g37<16,8,2>UW   { align1 1H $3.dst };
mach(8)         g39<1>UD        g29<1,1,0>UD    g35<1,1,0>UD    { align1 1Q compacted AccWrEnable };
add(16)         g41.1<2>UW      g41.1<16,8,2>UW g51<16,8,2>UW   { align1 1H I@3 };
mul(16)         g52<1>D         g29<8,8,1>D     g37.1<16,8,2>UW { align1 1H };
mul(8)          acc0<1>UD       g30<8,8,1>UD    g36<16,8,2>UW   { align1 2Q };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
add(16)         g47<1>D         g31<1,1,0>D     g41<1,1,0>D     { align1 1H $3.dst compacted };
add(16)         g43.1<2>UW      g43.1<16,8,2>UW g52<16,8,2>UW   { align1 1H I@3 };
...
cmp.l.f0.0(16)  g67<1>UD        g65<1,1,0>UD    g47<1,1,0>UD    { align1 1H I@4 compacted };
mov(8)          g71<2>UD        g65<4,4,1>UD                    { align1 1Q };
mov(8)          g73<2>UD        g66<4,4,1>UD                    { align1 2Q };
add3(16)        g51<1>D         g33<8,8,1>D     g45<8,8,1>D     -g49<1,1,1>D { align1 1H @6 $3.dst };
...
cmp.l.f0.0(16)  g76<1>F         (abs)g59<1,1,0>F 0x7f800000F  /* infF */ { align1 1H $4.dst compacted };
cmp.l.f0.0(16)  g78<1>F         (abs)g57<1,1,0>F 0x7f800000F  /* infF */ { align1 1H $4.dst compacted };
cmp.l.f0.0(16)  g82<1>F         (abs)g61<1,1,0>F 0x7f800000F  /* infF */ { align1 1H $4.dst compacted };
...
cmp.l.f0.0(16)  g86<1>F         (abs)g75<1,1,0>F 0x7f800000F  /* infF */ { align1 1H $5.dst compacted };
...
sel.ge(16)      g104<1>F        g61<1,1,0>F     g77<1,1,0>F     { align1 1H $5.dst compacted };
cmp.l.f0.0(16)  g88<1>F         (abs)g63<1,1,0>F 0x7f800000F  /* infF */ { align1 1H $4.dst compacted };
...
mov(16)         g53<2>W         -g96<8,8,1>D                    { align1 1H I@1 };
...
mov(16)         g20<1>UW        g53<16,8,2>UW                   { align1 1H I@4 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $2.src };
cbit(16)        g46<1>UD        g109<8,8,1>UD                   { align1 1H I@2 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        g21UD           g123UD          g46UD           0x0824058c                0x00000080
...
LABEL4:
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
add(16)         g124<1>D        g115<1,1,0>D    g21<0,1,0>D     { align1 1H $2.dst compacted };
...
mov(8)          g44<2>UD        g38<4,4,1>UD                    { align1 1Q $2.src };
mov(8)          g46<2>UD        g39<4,4,1>UD                    { align1 2Q $2.src };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $6.src };
mov(16)         g22<1>F         0x7f800000F      /* infF */     { align1 WE_all 1H $2.dst compacted };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $2.src };
add(16)         g47<1>F         g6<1,1,0>F      g14<1,1,0>F     { align1 1H I@7 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $2.src };
...
cmp.ge.f0.0(16) g55<1>F         g14<1,1,0>F     g6<1,1,0>F      { align1 1H $4.src compacted };
...
mov(4)          g70<4>UD        g20.1<8,2,4>UD                  { align1 WE_all 1N $5.src };
...
mov(4)          g122<4>UD       g30.1<8,2,4>UD                  { align1 WE_all 1N $2.src };
...
mov(4)          g44<4>UD        g32.3<8,2,4>UD                  { align1 WE_all 1N $2.src };
...
(+f0.0) sel(16) g47<1>UD        g21.7<0,1,0>UD  g89<1,1,0>UD    { align1 1H compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        nullUD          g83UD           g47UD           0x08040595                0x00000080
...
(+f0.0) sel(16) g48<1>UD        g29.7<0,1,0>UD  g100<1,1,0>UD   { align1 1H $7.src compacted };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        nullUD          g99UD           g48UD           0x08040596                0x00000080
...
sel.l(4)        g48<4>F         g50<8,2,4>F     g52<8,2,4>F     { align1 WE_all 1N $8.src };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N A@4 };
(+f0.0) sel(16) g49<1>UD        g34.7<0,1,0>UD  g116<1,1,0>UD   { align1 1H compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        nullUD          g110UD          g49UD           0x08040595                0x00000080
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N A@2 };
(+f0.0) sel(16) g50<1>UD        g40.7<0,1,0>UD  g2<1,1,0>UD     { align1 1H $9.src compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.dst };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.dst };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044231, 0x15140000, 0xfb187b24, 0x01002e14,
    0x00040025, 0x00004600, 0x00000000, 0x00000010,
    0x80001b01, 0x00000000, 0x00000000, 0x00000000,
    0xa07c2240, 0x15107302, 0x00040061, 0x00010660,
    0x20466a05, 0x00000000, 0x01040022, 0x0001c060,
    0x00000168, 0x00000168, 0x80003201, 0x00000000,
    ...
    0x27281970, 0x1f002603, 0x00033261, 0x2c060220,
    0x00342605, 0x00000000, 0x00133261, 0x2e060220,
    ...
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044231, 0x00000000, 0xfb082c24, 0x000c0c44,
    0x00040025, 0x00004600, 0x00000000, 0x00000010,
    0x80003601, 0x00000000, 0x00000000, 0x00000000,
    0x80003201, 0x00000000, 0x00000000, 0x00000000,
    ...
    0x80003601, 0x00000000, 0x00000000, 0x00000000,
    0xa3162261, 0x7f810000, 0x60160061, 0x00100600,
    ...
    0x80003201, 0x00000000, 0x00000000, 0x00000000,
    0x202f1f40, 0x0e000600, 0x80003201, 0x00000000,
    ...
    0x25373470, 0x06000e00, 0x80031e62, 0x39060aa0,
    0x5a441406, 0x00443b06, 0x80003501, 0x00000000,
    ...
    0x4a441e06, 0x00447206, 0x80003201, 0x00000000,
    ...
    0x80023561, 0x46070220, 0x00421427, 0x00000000,
    ...
    0x80023261, 0x7a070220, 0x00421e27, 0x00000000,
    ...
    0x80023261, 0x2c070220, 0x00422067, 0x00000000,
    ...
    0x2f2f0062, 0x59011583, 0x80001901, 0x00000000,
    0x00000000, 0x00000000, 0x00044731, 0x00000000,
    0xfb2a5324, 0x01002f14, 0xa05d0040, 0x00c04d03,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    ...
    0x2f303762, 0x64011d83, 0x00030061, 0x63060220,
    ...
    0xfb2c6324, 0x01003014, 0x00040025, 0x00004600,
    0x00000000, 0x00000010, 0xa3210961, 0x7f810000,
    0x60210061, 0x00103500, 0x80003801, 0x00000000,
    0x00000000, 0x00000000, 0xa3230061, 0x7f810000,
    ...
    0x52461a05, 0x00000003, 0x80003701, 0x00000000,
    ...
    0x00442b26, 0x00000000, 0x80031e62, 0x2d060aa0,
    0x5a442106, 0x00442f06, 0x80003801, 0x00000000,
    0x00000000, 0x00000000, 0x80031d62, 0x3a060aa0,
    ...
    0x00422b27, 0x00000000, 0x80023862, 0x30070aa0,
    ...
    0x80000c01, 0x00000000, 0x00000000, 0x00000000,
    0x2f310062, 0x74012283, 0x80001901, 0x00000000,
    0x00000000, 0x00000000, 0x00044931, 0x00000000,
    0xfb2a6e24, 0x01003114, 0xa0780040, 0x01006803,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    ...
    0x80000a01, 0x00000000, 0x00000000, 0x00000000,
    0x2f323962, 0x02012883, 0x80002001, 0x00000000,
    ...
    0xfb2c0124, 0x01003214, 0x00040025, 0x00004600,
...
const char *gfx125_bvh_build_primref_procedurals_to_primrefs_indirect_sha1 = "038881f8b0f1f61bd77cab85e78da03834a797e0";
